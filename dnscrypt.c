                        ...
                        const bool use_xchacha20)
{
    ...
    if (cache_get(&cached, query_header->publickey, keypair->crypt_publickey, use_xchacha20)) {
        ...
        cache_set(nmkey, query_header->publickey, keypair->crypt_publickey, use_xchacha20);
    }
